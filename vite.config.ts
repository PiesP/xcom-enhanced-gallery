...
export default defineConfig(({ mode }): UserConfig => {
  ...
  const featureMediaExtraction =
    featureMediaExtractionRaw === undefined
      ? true
      : !(
          featureMediaExtractionRaw === "0" ||
          featureMediaExtractionRaw.toLowerCase() === "false"
        );
        ...
        ...(isProd
          ? [
              ...
              },
              {
                ...
                replacement: resolve(
                  root,
                  "src/shared/error/app-error-reporter.slim.ts",
                ),
              },
              ...
              // that compile to no-ops in production but still take bytes in a non-minified build.
              {
                ...
                replacement: resolve(
                  root,
                  "src/shared/services/persistent-storage.slim.ts",
                ),
              },
            ]
          : []),
