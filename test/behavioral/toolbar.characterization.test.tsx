...
const queryToolbarButton = (container: HTMLElement, key: string) =>
  container.querySelector(`[data-gallery-element="${key}"]`) as HTMLButtonElement | null;

const queryAllToolbarButtons = (container: HTMLElement) =>
  Array.from(container.querySelectorAll('[data-toolbar-button="true"]')) as HTMLButtonElement[];
