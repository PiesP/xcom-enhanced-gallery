/**
 * 레이어 의존성 규칙 검증 (ARCHIVED)
 * @deprecated Phase 177: 구식 4-5계층 아키텍처 기준 (core, infrastructure 미사용)
 *            현재 프로젝트는 3계층 구조(Features → Shared → External) 사용
 *            의존성 검증은 dependency-cruiser로 대체됨
 * @see docs/ARCHITECTURE.md - 현재 3계층 구조
 * @see npm run deps:all - 의존성 검증 도구
 */
...
describe('ARCHIVED: Layer Dependency Rules', () => {
