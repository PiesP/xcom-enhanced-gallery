...
describe('Gallery keyboard navigation (Home/End/Page/Arrow/Space)', () => {
  ...
  // Phase 96.1: CI 환경에서는 Vendor 초기화 타이밍 이슈로 Skip
  // E2E 테스트로 기능 검증 완료 (Phase 82.7 K6)
  it.skipIf(process.env.CI === 'true')(
    'handles keys only when gallery is open and prevents default for navigation keys (E2E 이관 완료: Phase 82.7 K6)',
    async () => {
