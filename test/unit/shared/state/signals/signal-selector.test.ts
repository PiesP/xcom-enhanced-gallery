...
// Mock Solid.js solid-hooks module
...
describe('signal-selector', () => {
  describe('useSelector', () => {
    ...
    it('should use dependency-based caching when dependencies provided', () => {
      ...
      const selector: SelectorFn<State, string> = state => `${state.name}-${state.count}`;
    ...
    it('should work with array state', () => {
      ...
      const selector: SelectorFn<number[], number> = state => state.reduce((sum, n) => sum + n, 0);
    ...
    it('should handle selector that returns undefined', () => {
      ...
      const selector: SelectorFn<typeof signal.value, string | undefined> = state => state.optional;
    ...
    it('should handle selector that returns null', () => {
      ...
      const selector: SelectorFn<typeof signal.value, string | null> = state => state.nullable;
