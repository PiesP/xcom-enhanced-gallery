...
} from '@shared/services/bulk-download-service';
import type { MediaInfo } from '@shared/types';

// Phase 319: BulkDownloadService is deprecated (replaced by UnifiedDownloadService in Phase 312)
// These tests are kept for legacy compatibility but may be removed in future phases
describe.skip('BulkDownloadService (DEPRECATED - Phase 312)', () => {
