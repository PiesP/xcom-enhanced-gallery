...
describe('GalleryView 통합 컴포넌트', () => {
  ...
  describe('기본 동작', () => {
    it('미디어 아이템들을 렌더링해야 함', () => {
      render(<GalleryView mediaItems={mockMediaItems} layout='vertical' onClose={vi.fn()} />);
    ...
    it('레이아웃 모드가 적용되어야 함', () => {
      const { rerender } = render(
        <GalleryView mediaItems={mockMediaItems} layout='vertical' onClose={vi.fn()} />
      );

      expect(screen.getByTestId('gallery-view')).toHaveAttribute('data-layout', 'vertical');

      rerender(<GalleryView mediaItems={mockMediaItems} layout='horizontal' onClose={vi.fn()} />);
    ...
    it('닫기 기능이 동작해야 함', () => {
      ...
      render(<GalleryView mediaItems={mockMediaItems} layout='vertical' onClose={onCloseMock} />);
  ...
  describe('레이아웃 모드', () => {
    ...
    it('horizontal 레이아웃에서 적절한 클래스가 적용되어야 함', () => {
      render(<GalleryView mediaItems={mockMediaItems} layout='horizontal' onClose={vi.fn()} />);
  ...
  describe('에러 처리', () => {
    it('빈 미디어 배열을 처리해야 함', () => {
      render(<GalleryView mediaItems={[]} layout='vertical' onClose={vi.fn()} />);
    ...
    it('잘못된 미디어 타입을 처리해야 함', () => {
      ...
      render(<GalleryView mediaItems={invalidMedia} layout='vertical' onClose={vi.fn()} />);
