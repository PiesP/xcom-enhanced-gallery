 ...
 * @description Validate media extraction accuracy based on actual X.com HTML samples
 * @coverage Multiple media, single media, click detection, URL normalization
 */
...
/**
 * Media information from sample HTML files
 * Sample 1: Multi-media tweet with 4 images
 * Sample 2: Single-media tweet with 1 image
 */
const SAMPLE_DATA = {
  sample1: {
...
test.describe('Sample-Based Media Extraction', () => {
  ...
  test.describe('Sample 1: Multi-Media Tweet', () => {
    test('should setup gallery with 4 media items', async ({ page }) => {
      ...
      // Playwright environment constraint: eventHandlersRegistered might be false
