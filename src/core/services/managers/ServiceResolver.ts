/**
 * @fileoverview Service Resolver - 간소화된 버전
 * @version 2.0.0
 *
 * ServiceRegistry 의존성을 제거하고 ServiceConfig를 직접 받아서 처리하는 간소화된 버전
 * 복잡한 의존성 해결 대신 기본적인 서비스 인스턴스 생성에 집중
 */
