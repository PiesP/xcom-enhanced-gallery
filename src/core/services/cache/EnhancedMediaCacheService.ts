 ...
 * 향상된 미디어 캐시 서비스
 */
export class EnhancedMediaCacheService {
  private static instance: EnhancedMediaCacheService;
  private readonly cache = new Map<string, CacheItem>();
  private readonly DEFAULT_TTL = 5 * 60 * 1000; // 5분

  private constructor() {}

  public static getInstance(): EnhancedMediaCacheService {
    EnhancedMediaCacheService.instance ??= new EnhancedMediaCacheService();
    return EnhancedMediaCacheService.instance;
  }
