 ...
 * 개선된 페이지 스크롤 잠금 서비스
 */
export class EnhancedPageScrollLockService {
  private static instance: EnhancedPageScrollLockService;
  ...
  private initializeService(): void {
    try {
      ...
      logger.debug('EnhancedPageScrollLockService: Service ready');
    } catch (error) {
      logger.error('EnhancedPageScrollLockService: Initialization failed:', error);
    }
  }
  ...
  public static getInstance(): EnhancedPageScrollLockService {
    if (!EnhancedPageScrollLockService.instance) {
      EnhancedPageScrollLockService.instance = new EnhancedPageScrollLockService();
    }
    return EnhancedPageScrollLockService.instance;
  }
  ...
  public async preemptiveLock(): Promise<void> {
    ...
    if (!this.isServiceReady) {
      logger.warn('EnhancedPageScrollLockService: Service not ready, forcing initialization');
      this.initializeService();
    }
