...
import { MediaExtractionCoordinator } from './MediaExtractionCoordinator';
...
export class CoordinatorManager {
  ...
  private readonly extractionCoordinator: MediaExtractionCoordinator;
