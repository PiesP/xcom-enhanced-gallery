...
// 2. 통합 미디어 서비스 (MediaLoading, Prefetching, WebP 최적화, BulkDownload 통합)
// 2. 통합 미디어 서비스 (MediaLoading, Prefetching, WebP 최적화, BulkDownload 통합)
...
// 8. 서비스 관리 (ServiceDiagnostics 통합됨)
export { ServiceManager, serviceManager } from './ServiceManager';

// 9. 간단한 서비스 레지스트리 (Phase 4 간소화)
