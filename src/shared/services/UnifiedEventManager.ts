...
export class UnifiedEventManager {
  ...
  constructor() {
    ...
    logger.debug('UnifiedEventManager 초기화 완료');
  }
  ...
  public addEventListener<K extends keyof HTMLElementEventMap>(
    ...
    if (this.isDestroyed) {
      logger.warn('UnifiedEventManager가 파괴된 상태에서 addEventListener 호출');
      return this;
    }
  ...
  public addCustomEventListener(
    ...
    if (this.isDestroyed) {
      logger.warn('UnifiedEventManager가 파괴된 상태에서 addCustomEventListener 호출');
      return this;
    }
  ...
  public cleanup(): void {
    ...
    logger.debug('UnifiedEventManager DOM 이벤트 정리 완료');
  }
  ...
  public cleanupAll(): void {
    this.cleanupGallery();
    this.cleanup();
    logger.debug('UnifiedEventManager 전체 정리 완료');
  }
}
 ...
 */
export const TwitterEventManager = UnifiedEventManager;
