 ...
 * 컨테이너 생성 헬퍼 함수
 */
export function createIsolatedGalleryContainer(options: {
  onClose: () => void;
  useShadowDOM?: boolean;
  className?: string;
}): HTMLDivElement {
  ...
  container.setAttribute('data-gallery-isolated', 'true');
  container.setAttribute('aria-label', 'X.com Enhanced Gallery');
