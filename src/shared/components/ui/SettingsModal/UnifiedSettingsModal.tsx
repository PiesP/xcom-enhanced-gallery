/**
 * @fileoverview UnifiedSettingsModal - The single source of truth for all settings modal functionality
 * @description Unified Settings Modal that supports both panel and modal modes. Replaces SettingsModal and EnhancedSettingsModal.
 */
import {
  getPreact,
  getPreactHooks,
...
/**
 * UnifiedSettingsModal - The single, unified settings modal component
 *
 * This component consolidates all settings modal functionality:
 * - Panel mode (lightweight dropdown)
 * - Modal mode (full overlay with backdrop)
 * - Accessibility features (focus trap, scroll lock)
...
export function UnifiedSettingsModal({
  ...
  className = '',
  'data-testid': testId,
}: UnifiedSettingsModalProps): VNode | null {
  const { h } = getPreact();
