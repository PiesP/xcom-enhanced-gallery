  ...
  msg: {
    ...
    dl: {
      ...
      part: {
        ...
        resourceLimit:
          'تم حفظ {count} عناصر في ملف ZIP، وتم استبعاد {failed} عناصر بسبب بلوغ حد موارد المتصفح. نزّل الوسائط الكبيرة بشكل منفصل.',
      },
      noMedia: 'لا توجد وسائط محددة. يرجى إعادة فتح المعرض والمحاولة مجدداً.',
      zipFail: 'فشل حفظ ملف ZIP',
      zipTooLarge:
        'ملف ZIP هذا كبير جدًا بحيث لا يمكن معالجته بأمان في المتصفح. نزّل الوسائط الكبيرة بشكل منفصل.',
    },
    gal: {
