...
```typescript
// 중복 발견 지역:
- DOM 조작 함수들 (dom-utils, DOMEventManager)
- 미디어 URL 처리 (MediaClickDetector, media-url.util)
- 스크롤 관련 (useScrollDirection, scroll-utils, ScrollHelper)
- 성능 최적화 (memo, throttle, 가상화)
```
