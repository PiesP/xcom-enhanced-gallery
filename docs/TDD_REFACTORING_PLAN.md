...
현재 활성 Epic 없음. Epic `REF-LITE-V3`(Userscript 번들 경량화)의 Stage 1–3은
2025-09-25 기준으로 모두 완료되어 `TDD_REFACTORING_PLAN_COMPLETED.md`에 요약이
이관되었습니다. 향후 번들 경량화나 관련 개선은 백로그 검토 후 새로운 Epic으로
등록해 본 문서에 추가합니다.
