...
(function() {
	...
	*/
	...
	new DOMException("The operation was aborted by the user.", "AbortError");
	//#endregion
	...
	*/
	...
	var VerticalGalleryView_module_default = {
		container: "_container_xp3h7_38",
		toolbarWrapper: "_toolbarWrapper_xp3h7_44",
		itemsContainer: "_itemsContainer_xp3h7_48",
		uiHidden: "_uiHidden_xp3h7_165",
		isScrolling: "_isScrolling_xp3h7_172",
		empty: "_empty_xp3h7_246",
		galleryItem: "_galleryItem_xp3h7_252",
		itemActive: "_itemActive_xp3h7_263",
		toolbarHoverZone: "_toolbarHoverZone_xp3h7_289",
		initialToolbarVisible: "_initialToolbarVisible_xp3h7_302",
		toolbarButton: "_toolbarButton_xp3h7_327",
		emptyMessage: "_emptyMessage_xp3h7_334"
	};
	//#endregion
	...
	*/
	...
	var VerticalImageItem_module_default = {
		container: "_container_10ktx_10",
		active: "_active_10ktx_58",
		focused: "_focused_10ktx_71",
		imageWrapper: "_imageWrapper_10ktx_77",
		mediaAction: "_mediaAction_10ktx_92",
		placeholder: "_placeholder_10ktx_120",
		loadingSpinner: "_loadingSpinner_10ktx_134",
		image: "_image_10ktx_77",
		video: "_video_10ktx_143",
		loading: "_loading_10ktx_134",
		loaded: "_loaded_10ktx_164",
		fitOriginal: "_fitOriginal_10ktx_175",
		fitWidth: "_fitWidth_10ktx_183",
		fitHeight: "_fitHeight_10ktx_191",
		fitContainer: "_fitContainer_10ktx_199",
		errorIcon: "_errorIcon_10ktx_207",
		errorText: "_errorText_10ktx_212",
		error: "_error_10ktx_207"
	};
	//#endregion
	...
	*/
	...
	var Tooltip_module_default = {
		trigger: "_trigger_tmrh7_11",
		content: "_content_tmrh7_12",
		placementBottom: "_placementBottom_tmrh7_53",
		placementTop: "_placementTop_tmrh7_57",
		visible: "_visible_tmrh7_62",
		arrow: "_arrow_tmrh7_13",
		placementBottomArrow: "_placementBottomArrow_tmrh7_76",
		placementTopArrow: "_placementTopArrow_tmrh7_84",
		arrowInner: "_arrowInner_tmrh7_93",
		placementBottomArrowInner: "_placementBottomArrowInner_tmrh7_101",
		placementTopArrowInner: "_placementTopArrowInner_tmrh7_109"
	};
	//#endregion
	...
	*/
	function Tooltip(props) {
		...
		const tooltipClass = createMemo(() => {
			...
			const placementClass = pos.actualPlacement === "bottom" ? Tooltip_module_default.placementBottom : Tooltip_module_default.placementTop;
			return cx(Tooltip_module_default.content, Tooltip_module_default.visible, placementClass);
		});
		const arrowClass = createMemo(() => {
			const pos = activePosition();
			if (pos === null) return Tooltip_module_default.arrow;
			const placementClass = pos.actualPlacement === "bottom" ? Tooltip_module_default.placementBottomArrow : Tooltip_module_default.placementTopArrow;
			return cx(Tooltip_module_default.arrow, placementClass);
		});
		const arrowInnerClass = createMemo(() => {
			const pos = activePosition();
			if (pos === null) return Tooltip_module_default.arrowInner;
			const placementClass = pos.actualPlacement === "bottom" ? Tooltip_module_default.placementBottomArrowInner : Tooltip_module_default.placementTopArrowInner;
			return cx(Tooltip_module_default.arrowInner, placementClass);
		});
		onCleanup(() => {
			clearTimers();
			detachDescription();
	...
	*/
	...
	var SettingsControls_module_default = {
		body: "_body_yfnlb_18",
		bodyCompact: "_bodyCompact_yfnlb_20",
		setting: "_setting_yfnlb_19",
		settingCompact: "_settingCompact_yfnlb_20",
		label: "_label_yfnlb_95",
		compactLabel: "_compactLabel_yfnlb_107",
		select: "_select_yfnlb_136"
	};
	//#endregion
	...
	*/
	...
	var Toolbar_module_default = {
		toolbarButton: "_toolbarButton_utkha_17",
		galleryToolbar: "_galleryToolbar_utkha_16",
		settingsExpanded: "_settingsExpanded_utkha_155",
		tweetPanelExpanded: "_tweetPanelExpanded_utkha_156",
		stateIdle: "_stateIdle_utkha_164",
		stateLoading: "_stateLoading_utkha_165",
		stateDownloading: "_stateDownloading_utkha_166",
		stateError: "_stateError_utkha_167",
		toolbarContent: "_toolbarContent_utkha_174",
		toolbarControls: "_toolbarControls_utkha_18",
		counterBlock: "_counterBlock_utkha_18",
		separator: "_separator_utkha_204",
		downloadButton: "_downloadButton_utkha_21",
		mediaCounterWrapper: "_mediaCounterWrapper_utkha_242",
		mediaCounter: "_mediaCounter_utkha_19",
		currentIndex: "_currentIndex_utkha_267",
		totalCount: "_totalCount_utkha_272",
		progressBar: "_progressBar_utkha_19",
		progressFill: "_progressFill_utkha_291",
		fitButton: "_fitButton_utkha_20",
		closeButton: "_closeButton_utkha_343",
		settingsPanel: "_settingsPanel_utkha_22",
		tweetPanel: "_tweetPanel_utkha_23",
		panelExpanded: "_panelExpanded_utkha_357",
		tweetUrlLink: "_tweetUrlLink_utkha_365",
		tweetContent: "_tweetContent_utkha_366",
		tweetPanelBody: "_tweetPanelBody_utkha_434",
		tweetTextHeader: "_tweetTextHeader_utkha_441",
		tweetTextLabel: "_tweetTextLabel_utkha_449",
		tweetUrlSection: "_tweetUrlSection_utkha_535",
		tweetUrlIcon: "_tweetUrlIcon_utkha_579",
		tweetUrlLabel: "_tweetUrlLabel_utkha_586",
		tweetUrlValue: "_tweetUrlValue_utkha_592",
		tweetUrlDivider: "_tweetUrlDivider_utkha_600"
	};
	//#endregion
	...
	*/
		...
		createEffect(() => {
			...
			const handleKeyDown = (event) => {
				...
				const focusableElements = Array.from(containerEl.querySelectorAll(focusableSelectors)).filter((el) => {
					...
					return el.getClientRects().length > 0 && style.visibility === "visible" && style.display !== "none" && !el.closest("[hidden], [inert], [aria-hidden=\"true\"]");
				});
	...
	//#endregion
	//#region src/shared/components/ui/ErrorBoundary/ErrorBoundary.module.css
	var ErrorBoundary_module_default = {
		"xeg-error-boundary__title": "_xeg-error-boundary__title_djkqh_11",
		"xeg-error-boundary__body": "_xeg-error-boundary__body_djkqh_12",
		"xeg-error-boundary__action": "_xeg-error-boundary__action_djkqh_13",
		"xeg-error-boundary__reset": "_xeg-error-boundary__reset_djkqh_14"
	};
	//#endregion
	...
	*/
	function migrateVideoClickMode(gallery) {
		...
		if (typeof gallery.videoClickMode === "string") {
			if (VALID_VIDEO_CLICK_MODES$1.includes(gallery.videoClickMode)) return {};
		}
	...
	function migrateSettings(input, nowMs) {
		...
		if (isRecord(typed.gallery)) {
			const migration = migrateVideoClickMode(typed.gallery);
			if (migration.videoClickMode) typed.gallery.videoClickMode = migration.videoClickMode;
		}
		const pruned = pruneWithTemplate(typed, DEFAULT_SETTINGS);
		const merged = {
			...DEFAULT_SETTINGS,
			...pruned
		};
	...
	*/
	...
	var VALID_IMAGE_FIT_MODES = /* @__PURE__ */ new Set([
		"original",
		"fitWidth",
		"fitHeight",
		"fitContainer"
	]);
	var VALID_VIDEO_CLICK_MODES = /* @__PURE__ */ new Set([
		"block-all",
		"block-controls-only",
		"allow-all"
	]);
	...
	*/
	function normalizeStoredSettings(input, nowMs) {
		if (!isRecord(input)) return makeDefaults(nowMs);
	...
	function normalizeGallery(raw) {
		...
		return {
			...
			imageFitMode: typeof raw.imageFitMode === "string" && VALID_IMAGE_FIT_MODES.has(raw.imageFitMode) ? raw.imageFitMode : d.imageFitMode,
			theme: typeof raw.theme === "string" && VALID_THEMES.has(raw.theme) ? raw.theme : d.theme,
			...
			videoClickMode: typeof raw.videoClickMode === "string" && VALID_VIDEO_CLICK_MODES.has(raw.videoClickMode) ? raw.videoClickMode : d.videoClickMode
		};
	}
	...
	*/
	function validateSettingValue(key, value) {
		...
		switch (key) {
			...
			case "download":
			case "accessibility":
			case "features": return isRecord(value);
			case "gallery.preloadCount": return isFiniteNonNegativeNumber(value) && value <= 100;
			case "gallery.imageFitMode": return typeof value === "string" && VALID_IMAGE_FIT_MODES.has(value);
			case "gallery.theme": return typeof value === "string" && VALID_THEMES.has(value);
			...
			case "gallery.videoClickMode": return typeof value === "string" && VALID_VIDEO_CLICK_MODES.has(value);
	...
	*/
	var log = createLogger("ContentScript");
	if (isAllowedStartPage()) startApplication().catch((error) => {
